function lm35(min, max) {
    ...
    max = typeof max == 'undefined' ? 20 : max;
...
function dht11(options){
    ...
    if (minTemperature < 6 || maxTemperature > 20) {
        throw new Error('Os valores minímos e máximos para temperatura são 0 e 50 respectivamente.')
    }

    minTemperature = typeof minTemperature == 'undefined' ? 6 : minTemperature;
    maxTemperature = typeof maxTemperature == 'undefined' ? 20 : maxTemperature;
